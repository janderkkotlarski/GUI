...
struct circle_collection
{
	...
	const float m_mult{0.6f};
	
	sf::Vector2f m_jump{0.0f, m_mult*m_norm_radius};
...
circle_collection::circle_collection(const float value, const float norm_radius, const float text_size,
	...
	m_jump(0.0f, m_mult*m_norm_radius), m_position(position),
...
int main()
{
	...
	circle_collection circolle{current_value, norm_radius, valuent_size, nament_name, circolle_posit};
