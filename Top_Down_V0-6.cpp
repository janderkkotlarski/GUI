...
struct rectangle_entity
{
    ...
    rectangle_entity(const float value, const float norm_radius, const float text_size,
                            const std::string& name, const sf::Vector2f& position);
...
rectangle_entity::rectangle_entity(const float value, const float norm_radius, const float text_size,
                                   const std::string& name, const sf::Vector2f& position)
    :m_value(value), m_norm_radius(norm_radius), m_text_size(text_size), m_name(name), m_position(position),
     m_circolle(m_value, m_norm_radius, m_text_size, m_name, m_position)
{
...
void show_rectent(sf::RenderWindow& window, const rectangle_entity& rectent)
{
   ...
   show_circolle(window, rectent.m_circolle);
...
struct rectangle_collection
{
    ...
    rectangle_entity m_rectent{m_value, m_norm_radius, m_text_size, m_name, m_position};
...
rectangle_collection::rectangle_collection(const float value, const float norm_radius, const float text_size,
                                   const std::string& name, const sf::Vector2f& position)
    :m_value(value), m_norm_radius(norm_radius), m_text_size(text_size), m_name(name), m_position(position),
    m_rectent(m_value, m_norm_radius, m_text_size, m_name, m_position)
...
int main()
{
    ...
    const std::string program_name{"Top Down V0.6"};
    ...
    const std::string nament_name_2{"Argentum"};
